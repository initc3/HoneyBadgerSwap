...
// InputmaskCnt is a paid mutator transaction binding the contract method 0x93910e66.
//
// Solidity: function inputmaskCnt() returns(uint256)
func (_HbSwap *HbSwapTransactor) InputmaskCnt(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _HbSwap.contract.Transact(opts, "inputmaskCnt")
}

// InputmaskCnt is a paid mutator transaction binding the contract method 0x93910e66.
//
// Solidity: function inputmaskCnt() returns(uint256)
func (_HbSwap *HbSwapSession) InputmaskCnt() (*types.Transaction, error) {
	return _HbSwap.Contract.InputmaskCnt(&_HbSwap.TransactOpts)
}

// InputmaskCnt is a paid mutator transaction binding the contract method 0x93910e66.
//
// Solidity: function inputmaskCnt() returns(uint256)
func (_HbSwap *HbSwapTransactorSession) InputmaskCnt() (*types.Transaction, error) {
	return _HbSwap.Contract.InputmaskCnt(&_HbSwap.TransactOpts)
}
