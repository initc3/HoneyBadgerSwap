...
from utils import key_pool, key_total_supply, location_db, location_sharefile, openDB, from_hex, to_hex, sz
...
if __name__=='__main__':
    ...
    with open(file, 'rb') as f:
        ...
        amt_liquidity = from_hex(f.read(sz))
    ...
    print(amt_A, amt_B, amt_liquidity)